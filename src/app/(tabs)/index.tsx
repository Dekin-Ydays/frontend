...
export default function HomeScreen() {
  return (
    <ScrollView className="flex-1 bg-dark py-24">
      ...
      <AppText>Capture body poses with MediaPipe and compare videos using AI-powered scoring.</AppText>

      <Collapsible title="📹 Record Poses">
        <AppText>
          This demo uses <AppText className="font-semibold font-mono">@mediapipe/tasks-vision</AppText> on web to
          perform real-time body pose tracking. It detects 33 body landmarks including face, torso, arms, and legs.
        </AppText>
        ...
        <ExternalLink href="https://developers.google.com/mediapipe">
          <AppText className="text-blue-500">Learn more about MediaPipe</AppText>
        </ExternalLink>
      </Collapsible>
