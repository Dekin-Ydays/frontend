...
export function TopFeed() {
  ...
  return (
    <View className="absolute top-0 left-0 right-0 bg-gradient-to-t from-black/0 to-black/80 h-24 items-center justify-center" style={{ paddingTop: insets.top }}>
          ...
          return (
            ...
            >
              <View className="items-center">
                ...
                {isActive && <View className="absolute bottom-0 h-0.5 w-7 rounded-full bg-primary" />}
              </View>
            </Pressable>
          );
        })}
